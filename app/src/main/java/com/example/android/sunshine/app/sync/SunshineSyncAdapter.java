...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener{
    ...
    public final String LOG_TAG = "lello";//SunshineSyncAdapter.class.getSimpleName();
    public static final String ACTION_DATA_UPDATED =
            "com.example.android.sunshine.app.ACTION_DATA_UPDATED";
    // Interval at which to sync with the weather, in seconds.
    // 60 seconds (1 minute) * 180 = 3 hours
    public static final int SYNC_INTERVAL = 3;//TODO
    ...
    private void getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            mGoogleApiClient = new GoogleApiClient.Builder(getContext()).addApi(Wearable.API).addConnectionCallbacks(this).addOnConnectionFailedListener(this).build();
    ...
    public void onConnected(Bundle bundle) {
        ...
        try {
            largeIcon = Glide.with(getContext())
                    ...
                    .fitCenter()
                    .into(R.dimen.notification_large_icon_default, R.dimen.notification_large_icon_default).get();
        } catch (InterruptedException | ExecutionException e) {
            Log.e(LOG_TAG, "Error retrieving large icon from " + Utility.getArtUrlForWeatherCondition(getContext(), weatherId), e);
            largeIcon = BitmapFactory.decodeResource(getContext().getResources(), Utility.getArtResourceForWeatherCondition(weatherId));
        }
        ...
        new SendToDataLayer("/weather", highS, lowS, largeIcon).start();
    }
    ...
    class SendToDataLayer extends Thread {
        ...
        SendToDataLayer(String p, String high, String low, Bitmap largeIcon) {
    ...
    public void sendWeatherData(){
        ...
        putDataMapRequest.getDataMap().putAsset("image", createAssetFromBitmap(largeIcon));
    ...
    private void notifyWeather() {
        ...
        boolean displayNotifications = true;/*prefs.getBoolean(displayNotificationsKey,
                Boolean.parseBoolean(context.getString(R.string.pref_enable_notifications_default)));*/

        if ( displayNotifications ) { //TODO
                ...
                if (cursor.moveToFirst()) {
                    ...
                    NotificationCompat.Builder mBuilder =
                            new NotificationCompat.Builder(getContext())
                                    ...
                                    .setContentText(contentText);//TODO
